...
template <typename type>
Chrono<type>::Chrono(const Chrono& other) : m_start(other.m_start), m_stop(false), m_stopTime(Time())
{
}

template <typename type>
Chrono<type>::Chrono(Chrono&& other) noexcept : m_start(std::move(other.m_start)), m_stop(false), m_stopTime(Time())
{
}
